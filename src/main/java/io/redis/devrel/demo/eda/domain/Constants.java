...
public final class Constants {
    ...
    // outright; the native producer writes here and the consumer groups below read from it. Events
    // produced through the Kafka protocol land here too, via the Redis sink connector running on
    // Kafka Connect against Korvet (see docker-compose.yml). The pipeline is Korvet-agnostic.
